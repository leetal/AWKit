...
// AWKit
#define COCOAPODS_POD_AVAILABLE_AWKit
#define COCOAPODS_VERSION_MAJOR_AWKit 0
#define COCOAPODS_VERSION_MINOR_AWKit 1
#define COCOAPODS_VERSION_PATCH_AWKit 0
